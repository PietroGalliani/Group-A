...
public class LogoutActivity extends AsyncTask<String, Void, String> {
	public interface LogoutListener {
		void logoutSucceeded(int charSelected, String userID);

		void logoutFailed(String userID, String message);
	}
	...
	protected String doInBackground(String... params) {
		...
		try {
			...
			if (sb.toString().equals(username)) {
				mListener.logoutSucceeded(charSelected, sb.toString());
			} else
				mListener.logoutFailed(username, sb.toString());
